...
namespace DarkRiftSerializables {
    ...
    public class DarkRiftSerializablesAnalyzer : DiagnosticAnalyzer {
        public const string DiagnosticId = "DarkRiftSerializables";
        ...
        private const string Category = "DarkRift";
